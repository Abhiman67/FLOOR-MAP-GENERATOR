...
export default function HeroSection() {
  return (
    <div className="relative py-24 flex flex-col items-center justify-center bg-gradient-to-b from-amber-50 to-white border-b border-amber-100">
      ...
      >
        <motion.h1
          className="text-5xl md:text-6xl font-bold tracking-tight mb-2 text-amber-950"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.p
          className="text-sm tracking-widest text-amber-700 mb-6 font-semibold"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.p
          className="text-lg text-amber-800 font-light tracking-wide"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1, delay: 0.6 }}
        >
          Create Beautiful Floor Plans in Seconds
        </motion.p>
      </motion.div>
